...
func Migration() {
    ...
    // Apply migration
    database.AutoMigrate(&Model.User{}, &Model.Folder{}, &Model.File{}, &Model.Accesses{}, &Model.Status{}, &Model.RequestAccess{}, &Model.Keys{}, &Model.KeysSecondary{}, &Model.Chat{}, &Model.ChatUser{}, &Model.Message{})
    database.Migrator()
}